...
namespace ApiMovies.Migrations
{
    ...
    [Migration("20220303173255_RatingTable_Update")]
    partial class RatingTable_Update
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiMovies.Entities.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ApiMovies.Entities.Models.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApiMovies.Entities.Models.Rating", b =>
                {
                    ...
                    b.HasOne("ApiMovies.Entities.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ApiMovies.Entities.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
