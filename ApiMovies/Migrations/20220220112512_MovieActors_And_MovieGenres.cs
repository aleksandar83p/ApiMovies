...
{
    public partial class MovieActors_And_MovieGenres : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CharacterName = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: true),
                    OrderInCharactersList = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
